...
--
-- Host: db:3306
-- Generation Time: Jul 31, 2024 at 09:26 AM
...
(5, 'memFTest', 'memLTest', 'memUserTest', 'memPassTest', 'memTest@gmail.com', '0980000000', 1),
(7, 'TestFmem2', 'TestLmem2', 'TestUmem23', 'TestPmem2', 'Testmem2@gmail.com', '0987654321', 1),
(25, 'Anon', 'Chaiyasong', 'abcd', '1234', 'abcd@gmail.com', '0980960857', 1),
(26, 'testapp', 'testLapp', 'abbb', 'abbb', 'asdasdsad@gmail.com', '0945518201', 1),
(29, 'testapp', 'testLapp', 'gun', 'gungungun', 'gun@gmail.com', '0642623451', 1);
...
(42, 'ชุดพิธีการทีมชาติไทยติดไหม? “โอลิมปิก 2024” เผยยูนิฟอร์มนักกีฬา 5 ชาติ ดีไซน์สวยสุด', 'ว็บไซต์อย่างเป็นทางการโอลิมปิก เผยท็อป 10 ชุดชาติที่เข้าร่วมแข่งขันโอลิมปิก 2024\n\nวันที่ 25 กรกฎาคม 2567 ฝ่ายจัดแข่งโอลิมปิก 2024 ณ กรุงปารีส ประเทศฝรั่งเศส เขียนบทความจัด 5 อันดับแรก ยูนิฟอร์มนักกีฬาประจำชาติที่เข้าร่วมโอลิมปิกครั้งนี้\n\nโดยที่ยกมามีหลากหลายประเทศทั้ง มองโกเลีย ที่ก่อนหน้านี้ ศาสตราจารย์พิเศษ เจริญ วรรธนะสิน รองประธานกรรมการคณะกรรมการโอลิมปิคแห่งประเทศไทยฯ เคยบอกว่าไว้เหมือนงิ้ว รวมไปถึง เกาหลีใต้ และ เฮติ ที่เคยถูกพาดพิงก็ต่างติดท็อป 5 เข้ามาทั้งหมด', '2024-07-26 00:51:00', 6, 1),
...
--
ALTER TABLE `Member`
  MODIFY `Mem_Id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `News`
--
ALTER TABLE `News`
  MODIFY `News_Id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `Total_Read`
  MODIFY `Count_Id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
