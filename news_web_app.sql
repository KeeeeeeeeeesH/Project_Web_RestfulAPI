...
(14, 'ทดสอบ4', 'ทดสอบข่าวต่างประเทศ', '2024-05-12 17:21:15', 11, 2),
(20, 'test add sub cateeeee', 'asdassaasdsad', '2024-05-16 00:00:00', 10, 1);
...
--
ALTER TABLE `Sub_Category`
  MODIFY `Sub_Cat_Id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
ALTER TABLE `News_Sub_Cate`
  ...
  ADD CONSTRAINT `News_Sub_Cate_ibfk_2` FOREIGN KEY (`Sub_Cat_Id`) REFERENCES `Sub_Category` (`Sub_Cat_Id`) ON DELETE CASCADE ON UPDATE RESTRICT;
